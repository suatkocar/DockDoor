...
extension Defaults.Keys {
    ...
    static let dockShowHeaderAppIcon = Key<Bool>("dockShowHeaderAppIcon", default: true)
    static let dockShowHeaderAppName = Key<Bool>("dockShowHeaderAppName", default: true)

    // Dock embedded mode settings
    static let dockShowWindowTitle = Key<Bool>("dockShowWindowTitle", default: true)
    static let dockWindowTitleVisibility = Key<WindowTitleVisibility>("dockWindowTitleVisibility", default: .alwaysVisible)
    static let dockTrafficLightButtonsVisibility = Key<TrafficLightButtonsVisibility>("dockTrafficLightButtonsVisibility", default: .dimmedOnPreviewHover)
    static let dockEnabledTrafficLightButtons = Key<Set<WindowAction>>("dockEnabledTrafficLightButtons", default: [.quit, .close, .minimize, .toggleFullScreen])
    static let dockUseMonochromeTrafficLights = Key<Bool>("dockUseMonochromeTrafficLights", default: false)
    static let dockDisableDockStyleTrafficLights = Key<Bool>("dockDisableDockStyleTrafficLights", default: false)
    static let dockDisableDockStyleTitles = Key<Bool>("dockDisableDockStyleTitles", default: false)
    static let dockDisableButtonHoverEffects = Key<Bool>("dockDisableButtonHoverEffects", default: false)
    static let dockShowTrafficLightTooltips = Key<Bool>("dockShowTrafficLightTooltips", default: true)
    ...
    static let switcherShowTrafficLightTooltips = Key<Bool>("switcherShowTrafficLightTooltips", default: true)
